...
export const StyledGeneralIdContain = styled.div`
  display: flex;
...
`
export const StyledHostIdAndTagsContain = styled.div`
  display: flex;
  justify-content: space-between;
  margin-top: ${Margin.mainMarginTop};
  flex-direction: column;
...
`
export const StyledProfilAndStarsContain = styled.div`
  display: flex;
  flex-direction: column;
